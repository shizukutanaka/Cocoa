...
_DIRECT_PUSH_KINDS = frozenset({
    ...
    "commission_disputed",   # the other party: a commission was flagged for admin review
    ...
    "report_reviewed",       # reporter: a listing/review report they filed was adjudicated
})
